...
public class StudentCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("firstname"))) {
			...
			request.setAttribute("firstname", PropertyReader.getValue("error.require", "First Name must be in character"));
			pass = false;
		}
		if (DataValidator.isNull(request.getParameter("lastname"))) {
			...
			request.setAttribute("lastname", PropertyReader.getValue("error.require", "Last Name must be in character"));
			pass = false;
		}
		if (DataValidator.isNull(request.getParameter("mobile"))) {
			...
			request.setAttribute("mobile", PropertyReader.getValue("error.require", "Mobile No be an interger and start with 6-9"));
			pass = false;
		}
