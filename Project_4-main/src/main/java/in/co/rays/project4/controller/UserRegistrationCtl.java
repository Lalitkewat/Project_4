	...
	protected boolean validate(HttpServletRequest request) {
      ...
      log.debug("UserRegistrationCtl Method validate Started");
		...
		if (DataValidator.isNull(request.getParameter("firstName"))) {
			...
			request.setAttribute("firstName", PropertyReader.getValue("error.require","First Name should be in Character" ));
			pass = false;
		}
		...
		if (DataValidator.isNull(request.getParameter("lastName"))) {
			...
			request.setAttribute("lastName", PropertyReader.getValue("error.require","Last Name should be in Character" ));
			pass = false;
		}
		...
		if (DataValidator.isNull(request.getParameter("confirmPassword"))) {
			...
			request.setAttribute("confirmPassword", PropertyReader.getValue("error.require", "Confirm Password must be same as password"));
			pass = false;
		...
		if (DataValidator.isNull(request.getParameter("mobilenumber"))) {
			...
			request.setAttribute("mobilenumber", PropertyReader.getValue("error.require", "Mobile Number  must be an integer start with 6-9"));
			pass = false;
		}
