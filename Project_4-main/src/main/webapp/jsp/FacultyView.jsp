...
<tr><th style="padding: 3px"></th></tr> 
				...
				<tr>
					...
					<td><input type="text" name="firstname"
						placeholder=" Enter First Name" size="24.9px"
...
<tr><th style="padding: 3px"></th></tr> 
				<tr>
					...
					<td><input type="text" name="lastname"
						placeholder=" Enter last Name" size="24.9px"
...
<tr><th style="padding: 3px"></th></tr> 
					...
					<td><input type="text" name="loginid"
						placeholder=" Enter Login Id" size="24.9px"
...
<tr><th style="padding: 3px"></th></tr> 
				<tr>
					...
					<td><input type="text" name="doj" id="udateee"
						placeholder="Enter Date Of Joining " size="24.9px"
...
<tr><th style="padding: 3px"></th></tr> 
				...
				<tr>
					...
					<td><input type="text" name="qualification" size="24.9px"
...
<tr><th style="padding: 3px"></th></tr> 
				...
				<tr>
					...
					<td><input type="text" name="mobileno" size="24.9px" maxlength="10"
