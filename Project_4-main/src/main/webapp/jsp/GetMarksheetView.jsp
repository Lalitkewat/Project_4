...
<%@page import="in.co.rays.project4.controller.GetMarksheetCtl"%>
    ...
    <center>
        <div align="center">
            ...
            <br>
				...
				<td><input type="text" name="rollNo" placeholder="Enter Your Roll No" size="25" value="<%=ServletUtility.getParameter("rollNo", request)%>">
