...
<!DOCTYPE html>
<%@page import="in.co.rays.project4.model.FacultyModel"%>
<%@page import="in.co.rays.project4.bean.FacultyBean"%>
...
<form action="<%=ORSView.FACULTY_LIST_CTL %>" method="post">
	...
	<div align="center">
			...
			<h1><font style="color: red"><%=ServletUtility.getErrorMessage(request) %></font> </h1>
	</div>
