...
<body>
	...
	<table>
	  ...
	  <tr><th style="padding: 3px"></th></tr>    	
		...
		<td><input type="text" name="firstname" placeholder="Enter First Name" size="24.9px" value="<%=DataUtility.getStringData(bean.getFirstName())%>"></td>
		...
		<td><input type="text" name="lastname" placeholder="Enter Last Name" size="24.9px" value="<%=DataUtility.getStringData(bean.getLastName())%>"></td>
		...
		<tr>
					...
					<td><input type="text" name="dob" id="datepicker"
						placeholder="Enter Date Of Birth" size="24.9px" readonly="readonly"
		...
		<td><input type="text" name="mobile" maxlength="10" placeholder="Enter Mobile No" size="24.9px" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
		...
		<td><input type="text" name="email" placeholder="Enter Email_Id" size="24.9px" value="<%=DataUtility.getStringData(bean.getEmail())%>"></td>
