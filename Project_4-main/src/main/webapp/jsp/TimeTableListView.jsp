...
<!DOCTYPE html>
<%@page import="in.co.rays.project4.model.TimetableModel"%>
...
<%@page import="in.co.rays.project4.bean.TimetableBean"%>
...
<body >
<jsp:useBean id="bean" class="in.co.rays.project4.bean.TimetableBean" scope="request"></jsp:useBean>
...
<form action="<%=ORSView.TIMETABLE_LIST_CTL %>" method="post"> 
	...
	<table width ="100%">
		...
		<input type ="text"  name="Exdate" readonly="readonly" id ="udate6" placeholder="Select Date" value="<%=DataUtility.getDateString(bean.getExamDate()) %>">		
		&nbsp;
