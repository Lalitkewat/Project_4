        ...
        <center>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="firstName" size="24.9"  placeholder="Enter First Name" 
                        value="<%=DataUtility.getStringData(bean.getFirstName())%>"></td><td style="position: fixed"><font
                        color="red"> <%=ServletUtility.getErrorMessage("firstName", request)%></font></td>
                </tr>
                <tr>
                    <th align="left">Last Name<span style="color : red">*</span></th>
                    <td><input type="text" name="lastName" size="24.9" placeholder="Enter Last Name"
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" size="24.9"  placeholder="Enter Login Id"
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" size="24.9" placeholder="Enter Password"
                 ...
                 <tr> 
                     ...
                     <td><input type="password" name="confirmPassword" size="24.9" placeholder="Enter Confirm Password"
				...
				<tr> 
                     ...
                     <td><input type="text" name="mobilenumber" size="24.9" maxlength="10" placeholder="Enter Mobile Number" 
                         value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td><td style="position: fixed"><font 
                         color="red"> <%=ServletUtility.getErrorMessage("mobilenumber", request)%></font></td>
                 </tr>
                <tr>
                    <th align="left">Date Of Birth<span style="color : red">*</span></th>
                    <td><input type="text" name="dob" readonly="readonly"  id="datepicker" size="24.9" placeholder=" Enter Date of Birth " 
                        value="<%=DataUtility.getDateString(bean.getDob())%>"> 
                        
                    </td><td style="position: fixed"><font color="red"> <%=ServletUtility.getErrorMessage("dob", request)%></font></td>
                </tr>
                <tr>
                    <th></th>
                    <td colspan="2">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
