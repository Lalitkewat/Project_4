...
<body>
<jsp:useBean id="bean" class="in.co.rays.project4.bean.SubjectBean" scope="request"></jsp:useBean>
...
<div>	
	...
	<td><input type="text" name="name" placeholder="Enter Subject Name" size="24.9px" value="<%=DataUtility.getStringData(bean.getSubjectName())%>">
	...
	<td><input type="text" name="description" placeholder="Enter Description" size="24.9px" value="<%=DataUtility.getStringData(bean.getDescription())%>">
