   ...
   <center>
    ...
    <div align="center">    
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="firstName" placeholder="Enter First Name" size="24.9px"  value="<%=DataUtility.getStringData(bean.getFirstName())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <tr>
                    ...
                    <td><input type="text" name="lastName" placeholder="Enter Last Name" size="24.9px" value="<%=DataUtility.getStringData(bean.getLastName())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" placeholder="Enter Vallid Email-Id" size="24.9px" value="<%=DataUtility.getStringData(bean.getLogin())%>"
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" placeholder="Enter Password" size="24.9px"value="<%=DataUtility.getStringData(bean.getPassword())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" name="confirmPassword" placeholder="Re-Enter Password" size="24.9px" value="<%=DataUtility.getStringData(bean.getPassword())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
                  ...
                  <tr> 
                   ...
                   <font color="red"> 
                 <%=ServletUtility.getErrorMessage("roleId", request)%></font>
                   </td>
                 </tr> 
...
<tr><th style="padding: 3px"></th></tr> 
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" id="datepicker" placeholder="Greater then 18 year"  size= "24.9px" readonly="readonly"  value="<%=DataUtility.getDateString(bean.getDob())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="mobileno" maxlength="10" placeholder="Enter Mobile No" size= "24.9px" value="<%=DataUtility.getStringData(bean.getMobileNo())%>">
